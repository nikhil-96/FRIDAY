...
class FloorCleaning(Env):
    ...
    def render(self, mode="human"):
        ...
        for ob in self._grid.dirt_places:
            plt.fill([ob.x1, ob.x2, ob.x2, ob.x1, ob.x1], [ob.y1, ob.y1, ob.y2, ob.y2, ob.y1], color='#ffcdb2', alpha = 0.5)

        for ob in self._grid.death:
            plt.fill([ob.x1, ob.x2, ob.x2, ob.x1, ob.x1], [ob.y1, ob.y1, ob.y2, ob.y2, ob.y1], color='#e5989b', alpha = 0.5)

        for ob in self._grid.much_dirt_places:
            plt.fill([ob.x1, ob.x2, ob.x2, ob.x1, ob.x1], [ob.y1, ob.y1, ob.y2, ob.y2, ob.y1], color='#ffb4a2', alpha = 0.5)

        for goal in self._grid.goals:
            plt.fill(
                [goal.x1, goal.x2, goal.x2, goal.x1, goal.x1],
                [goal.y1, goal.y1, goal.y2, goal.y2, goal.y1],
                color='#b5838d', alpha = 0.5
            )

        for ob in self._grid.obstacles:
            plt.fill([ob.x1, ob.x2, ob.x2, ob.x1, ob.x1], [ob.y1, ob.y1, ob.y2, ob.y2, ob.y1], color='#d5bdaf', alpha = 0.5)

        for ob in self._grid.walls:
            plt.fill([ob.x1, ob.x2, ob.x2, ob.x1, ob.x1], [ob.y1, ob.y1, ob.y2, ob.y2, ob.y1], color='black', alpha = 0.5)
